 ...
 */
export function NeonButton({ label, onClick, icon, fullWidth, variant = "primary", disabled, type = "button" }: Readonly<NeonButtonProps>) {
  const gradient = {
  ...
  return (
    <button
      ...
      style={{ width: fullWidth ? "100%" : "auto", backgroundImage: gradient }}
      onClick={onClick}
      disabled={disabled}
      type={type}
    >
